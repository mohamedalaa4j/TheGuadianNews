...
//                            }, 1500)
    ...
    private fun apiCall() {
        ...
        val url =
            ...
            "https://content.guardianapis.com/search?section=music&q=&page=$page&show-fields=thumbnail&order-by=newest&api-key=43f906b3-25e9-4762-9233-29811f58038b"
    ...
    private fun apiCallSearch() {
        ...
        val url =
            "https://content.guardianapis.com/search?q=$searchKeyword&section=music&show-fields=thumbnail&order-by=relevance&page-size=50&api-key=43f906b3-25e9-4762-9233-29811f58038b"
        Log.i("link", url)
        val jsonObjectRequest = JsonObjectRequest(
            Request.Method.GET, url, null,
            { response ->
